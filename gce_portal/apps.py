...
# Details on the Globus Search index
SEARCH_INDEXES = {
    "gce": {
        ...
        "facets": [
            {"name": "Stellar yields (table)", "field_name": "table"},
            {"name": "Star formation efficiency (sfe)", "field_name": "sfe"},
        ],
        "fields": [
            ("title", fields.title),
